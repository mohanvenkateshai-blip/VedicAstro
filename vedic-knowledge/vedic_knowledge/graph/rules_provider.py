...
# Soft deps: TRANSIT_HOUSES fallback + optional knowledge_engine gateway
try:
    from vedic_engine.rules.transit_rules import TRANSIT_HOUSES
except ImportError:  # package used outside VedicAstro
    TRANSIT_HOUSES = {}
...
def _get_graph_for_rules():
    try:
        try:
            from vedic_knowledge.knowledge.integration import get_safe_graph
        except ImportError:
            from knowledge_engine.integration import get_safe_graph  # type: ignore
