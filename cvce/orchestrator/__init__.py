...
class EngineRegistration:
    def __init__(self, id: str, name: str, purpose: str, endpoint: str, inputs: list, outputs: list, keywords: list, depends_on: list = None):
        self.id = id
        self.name = name
...
class Orchestrator:
    ...
    def _init_defaults(self):
        self.register(EngineRegistration(
            id="janma-kundali",
            ...
            keywords=["chart", "birth", "kundali", "horoscope", "janma", "rasi", "navamsa", "varga", "ashtakavarga", "lagna", "pushkar"],
        ))
        self.register(EngineRegistration(
            id="gochar-phala",
            ...
            outputs=["transit_verdicts, gochar_score, vedha_flags, tara_result, moorthi_result, sade_sati_status"],
            keywords=["transit", "gochar", "today", "prediction", "vedha", "tara", "moorthi", "sade sati", "latta", "chandra bala"],
        ...
        self.register(EngineRegistration(
            ...
            keywords=["dasha", "dasa", "vimshottari", "yogini", "ashtottari", "period", "maha", "antar", "pratyantar", "sookshma", "prana", "bhukti"],
            depends_on=["janma-kundali"],
        ))
        self.register(EngineRegistration(
            id="yoga-phala",
            ...
            keywords=["yoga", "raja", "dhana", "mahapurusha", "chandra", "nabhasa", "combination", "pancha", "ruchaka", "hamsa", "malavya"],
            depends_on=["janma-kundali"],
        ))
        self.register(EngineRegistration(
            id="bala-nirnaya",
            ...
            keywords=["strength", "bala", "shadbala", "dignity", "exalted", "debilitated", "combust", "bindus", "power", "weak", "strong"],
            depends_on=["janma-kundali"],
        ))
        self.register(EngineRegistration(
            id="muhurta-nirnaya",
            ...
            outputs=["ranked_muhurta_windows, panchanga_verdicts, tara_chandrabala_status, best_window"],
            keywords=["muhurta", "election", "window", "wedding", "auspicious", "shubh", "time", "rahu kalam", "abhijit", "brahma"],
        ...
        self.register(EngineRegistration(
            ...
            keywords=["compatibility", "koota", "matching", "guna", "milan", "marriage", "kuja dosha", "manglik", "nadi", "bhakoot", "gana"],
            depends_on=["janma-kundali"],
        ))
        self.register(EngineRegistration(
            id="shastra-pramana",
            ...
            outputs=["classical_citations, text_sources, conflicting_views, sanskrit_originals"],
            keywords=["citation", "source", "classical", "text", "verse", "shastra", "reference", "bphs", "phaladeepika", "why", "proof", "pramana"],
            depends_on=["janma-kundali"],
        ))
        ...
        for eng in self._engines.values():
            ...
            for kw in eng.keywords:
                if kw in query_lower:
                    ...
                    matches.append(kw)
            if score > 0:
                scored.append({"engine": eng.id, "name": eng.name, "score": score, "matched_keywords": matches, "endpoint": eng.endpoint, "purpose": eng.purpose})
            ...
            "engines": [
                {
                    ...
                    "endpoint": e.endpoint, "inputs": e.inputs, "outputs": e.outputs,
                    "keywords": e.keywords, "depends_on": e.depends_on,
    ...
    def engine_for(self, feature: str) -> Optional[dict]:
