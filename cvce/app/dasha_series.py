...
def _planet_rashi(gochar, planet_name: str) -> str | None:
...
def build_dasha_series(
    ...
    for d in samples:
        try:
            ...
            planet_scores = {
                pred.planet: pred.score for pred in (g.planet_predictions if g else [])
            }
    ...
    return {
        ...
        "stats": {
            ...
            "lagna_trough": {
                "date": lagna_trough["date"],
                "score": lagna_trough["lagna_combined_score"],
            },
        },
    }
