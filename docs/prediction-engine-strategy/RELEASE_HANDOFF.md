...
- **B3 raw research service:** remediation is complete for distinct high-entropy credentials, mounted persistence, bounded SQL paging, strict JSON intake and shutdown lifecycle. Independent re-gate **passed 97/100 on 2026-07-18**; raw research remains disabled by default and no Fly volume or secret was provisioned remotely.
